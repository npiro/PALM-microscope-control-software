...
influence_matrix=influence_matrix/wavelength;
...
for m=2:NumZernikeModes
    ...
    [fi u] = IM_controllo_ca_deriv(influence_matrix,ThisZernikeModeSq(:),1,1);
    AmplitudesForEachZernikeMode(:,m) = u;
    surface1 = reshape(fi,120,120);  
    [fi u] = IM_controllo_ca_deriv(influence_matrix,ThisZernikeModeSqNeg(:),1,1);
    AmplitudesForEachZernikeModeNeg(:,m) = u;
    surface2 = reshape(fi,120,120);    
